...
pollution_data <- read.csv("pollutionData209960.csv")


# For splitting the data set 
n_train <- round(nrow(data) * 0.97)
...
#   15.25489           24.14467            18.58021          21.27407

#   mape_1_lower_95    mape_2_lower_95     mape_3_lower_95   mape_4_lower_95
#   86.75551           95.14600            89.42149          92.11907

#   mape_1_upper_80    mape_2_upper_80     mape_3_upper_80   mape_4_upper_80
#   7.174769           8.770631            7.142690          7.765319

#   mape_1_lower_80    mape_2_lower_80     mape_3_lower_80   mape_4_lower_80
#   69.45862           74.57970            70.94637          72.62879


#so upper 95, and upper 80 bounds performed well,in upper 80 bound 
...
ggsave('lower 95.png',img_l95,width = 10, height = 4, dpi = 300)
...
ggsave('upper 95.png',img_u95,,width = 10, height = 4, dpi = 300)
...
ggsave('lower 80.png',img_l80,,width = 10, height = 4, dpi = 300)
...
ggsave('upper 80.png',img_u80,,width = 10, height = 4, dpi = 300)
